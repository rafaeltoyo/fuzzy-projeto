...
from base import TriagularMFunction
from base.operation import StdUnion, StdIntersection, StdComplement
from base.operation import TNorm1, TNorm9
from base.operation import CoNorm4, CoNorm9
